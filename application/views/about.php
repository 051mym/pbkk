  ...
  <section id="team">
    <div class="container wow fadeInUp">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="member">
            <div class="pic"><img class="img-usr" src="<?php echo base_url(); ?>img/usr.png" alt=""></div>
            <h4>Yusuf Mukharom</h4>
            <span>Programmer</span>
            <div class="social">
              <a href="https://twitter.com/YMukharom"><i class="fa fa-twitter"></i></a>
              <a href="https://www.facebook.com/people/Muhammad-Yusuf/100013045591787"><i class="fa fa-facebook"></i></a>
              <!-- <a href=""><i class="fa fa-google-plus"></i></a> -->
              <a href="https://www.linkedin.com/in/yusuf-mukharom-3aa71a15b/"><i class="fa fa-linkedin"></i></a>
            </div>
          </div>
        </div>
